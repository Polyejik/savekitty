(()=>{
  ...
  const slides={
    ru:[
      {
        title:'Сначала делим',
        coach:'Я Пушок. Представь миски для котлеток: в одну миску помещается 4 сочные котлетки. Сейчас у нас 8 котлеток. Сколько полных мисок? Две. Поэтому пишем 2 в ответ.',
        q:'2', showSub1:false, showRem:false, showDown:false, showSub2:false, focus:'d8'
      },
      {
        title:'Вычитаем',
        coach:'Две полные миски — это 2 × 4 = 8 котлеток. Все 8 уже разложили по мискам, поэтому здесь остаётся 0.',
        q:'2', showSub1:true, showRem:true, showDown:false, showSub2:false, focus:'p8'
      },
      {
        title:'Сносим цифру',
        coach:'Теперь берём следующую цифру справа — 4 — и сносим её вниз. Представь, что перед нами появились ещё 4 котлетки. Снова считаем, сколько полных мисок получится.',
        q:'2', showSub1:true, showRem:true, showDown:true, showSub2:false, focus:'d4'
      },
      {
        title:'Получаем 21',
        coach:'Четыре котлетки как раз заполняют одну миску. Пишем 1 рядом с 2. Получился ответ 21. Всё, теперь попробуй сам — я рядом!',
    ...
    en:[
      {
        ...
        coach:'I’m Pushok. Imagine bowls for tasty meatballs: one bowl holds 4 meatballs. Right now we have 8. How many full bowls? Two. So write 2 in the answer.',
        q:'2', showSub1:false, showRem:false, showDown:false, showSub2:false, focus:'d8'
      },
      {
        title:'Subtract',
        coach:'Two full bowls means 2 × 4 = 8 meatballs. All 8 are used, so 0 is left here.',
        q:'2', showSub1:true, showRem:true, showDown:false, showSub2:false, focus:'p8'
      },
      {
        title:'Bring down the next digit',
        coach:'Now bring down the next digit on the right — 4. Imagine 4 more meatballs appearing in front of us. We count full bowls again.',
        q:'2', showSub1:true, showRem:true, showDown:true, showSub2:false, focus:'d4'
      },
      {
        title:'The answer is 21',
        coach:'Four meatballs fill exactly one bowl. Write 1 next to 2. The answer is 21. Done — now you try, and I’ll stay with you!',
        q:'21', showSub1:true, showRem:false, showDown:true, showSub2:true, focus:'q1'
      }
    ]
  };
  ...
  function ensureModal(){
    ...
    w.innerHTML=`<div class="pk2-card" role="dialog" aria-modal="true">
      ...
      <div class="pk2-board">
        <div class="pk2-math">
          <div class="pk2-left">
            <div class="pk2-row pk2-source"><div class="pk2-sign"></div><div class="pk2-cell" id="pk2-d8">8</div><div class="pk2-cell" id="pk2-d4">4</div></div>
            <div class="pk2-row pk2-sub1row"><div class="pk2-sign" id="pk2-minus1">−</div><div class="pk2-cell line" id="pk2-p8">8</div><div class="pk2-cell"></div></div>
            <div class="pk2-row pk2-workrow"><div class="pk2-sign"></div><div class="pk2-cell blue" id="pk2-rem0">0</div><div class="pk2-cell blue pk2-down4" id="pk2-down4">4</div></div>
            <div class="pk2-row pk2-sub2row"><div class="pk2-sign" id="pk2-minus2">−</div><div class="pk2-cell"></div><div class="pk2-cell line" id="pk2-p4">4</div></div>
          </div>
