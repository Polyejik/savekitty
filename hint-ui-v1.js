(()=>{
  ...
  const css=`
    #hintPanel{position:relative!important;display:block!important;grid-template-columns:1fr!important;padding:14px 10px 10px!important;background:linear-gradient(180deg,#fff8e8,#fff1cf)!important;border:1px solid #e2bf78!important;border-radius:14px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.75)!important}
    ...
    #hintCloseX{position:absolute;top:6px;right:7px;width:34px;height:34px;border:0;border-radius:50%;background:#fff9ed;color:#5a402a;box-shadow:0 2px 8px rgba(79,52,24,.14);font:900 24px/30px system-ui;display:flex;align-items:center;justify-content:center;z-index:2;cursor:pointer}
    ...
    #timesTable:before{content:attr(data-title);grid-column:1/-1;display:block;text-align:center;font:950 16px/1.2 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#5c3d28;margin:0 34px 2px;padding:4px 8px}
    ...
    @media(max-width:430px){
      #hintPanel{padding:12px 8px 8px!important}
      #hintCloseX{top:5px;right:5px;width:32px;height:32px;font-size:22px}
